package com.eh.eventservice.application.constants;

public class ApplicationConstants {
    public static final String MSG_CATEGORY_NAME_NOT_BLANK = "Category name must not be blank";
    public static final String MSG_CATEGORY_NAME_MAX_SIZE = "Category name must not exceed 100 characters";
    public static final String MSG_EVENT_NAME_NOT_BLANK = "Event name must not be blank";
    public static final String MSG_EVENT_DESCRIPTION_NOT_BLANK = "Event description must not be blank";
    public static final String MSG_EVENT_DATE_NOT_NULL = "Event date must not be null";
    public static final String MSG_EVENT_START_TIME_NOT_NULL = "Event start time must not be null";
    public static final String MSG_EVENT_END_TIME_NOT_NULL = "Event end time must not be null" ;
    public static final String MSG_EVENT_CITY_NOT_BLANK = "Event city must not be blank";
    ...
    public static final String MSG_EVENT_CREATED_AT_NOT_NULL = "Event created at must not be null";
